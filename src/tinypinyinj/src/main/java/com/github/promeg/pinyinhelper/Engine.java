...
public final class Engine {
    ...
    public static Comparator<Emit> getEmitComparator() {
        return EMIT_COMPARATOR;
    }
    ...
    static String toPinyin(final String inputStr, final Trie trie, final List<PinyinDict> pinyinDictList,
        ...
        List<Emit> selectedEmits = select(inputStr, trie, selector);
    ...
    public static List<Emit> select(final String inputStr, final Trie trie, final SegmentationSelector selector) {
        List<Emit> selectedEmits = selector.select(trie.parseText(inputStr));
        Collections.sort(selectedEmits, EMIT_COMPARATOR);
        return selectedEmits;
    }
